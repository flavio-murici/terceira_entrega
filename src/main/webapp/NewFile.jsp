...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="ReadController">LISTAR</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="sobre.html">ATUALIZAR</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="contato.html">EXCLUIR</a>
                        </li>
                    </ul>
                </div>
            </div>
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-6">
				<h1 class="mt-5" >Cadastro do usuário</h1>
